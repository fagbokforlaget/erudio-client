...
describe('Should respond with valid data', () => {
  ...
  it('Should return node details', async () => {
    ...
    mock
      .onGet(
        `${structureService}children/nodes/fb29c948-327f-4f56-abb5-247e4cec5a22`,
      )
      .replyOnce(200, nodeList);
    mock
      .onGet(`${contentFusionService}b942d4de-921c-4406-abbd-464dabb7b210`)
      .replyOnce(200, content);
    const ec = new ErudioClient('dev.example.com');
